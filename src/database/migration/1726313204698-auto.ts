...
export class Auto1726313204698 implements MigrationInterface {
    name = 'Auto1726313204698'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "protocol_files" ("id" SERIAL NOT NULL, "filename" character varying NOT NULL, "pdfData" bytea NOT NULL, "protocolID" integer, CONSTRAINT "REL_1f8e85327724d2ebf29f8627eb" UNIQUE ("protocolID"), CONSTRAINT "PK_44706141f7d2143ce754bd58768" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "customers" ("id" SERIAL NOT NULL, "customerName" character varying NOT NULL, "address" character varying NOT NULL, "rasSch" character varying, "unp" integer, "bank" character varying, "bankAddress" character varying, "bic" integer, "okpo" integer, "passport" character varying, "phone" character varying NOT NULL, "fax" character varying, "email" character varying, "customerTypeID" integer, CONSTRAINT "UQ_e2da704219d0812f0ea46ff50b2" UNIQUE ("customerName"), CONSTRAINT "PK_133ec679a801fab5e070f73d3ea" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "issue_journal" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "issueMethodID" integer, "protocolID" integer, CONSTRAINT "REL_19316060c32175b5c99f1c7fb2" UNIQUE ("issueMethodID"), CONSTRAINT "REL_bb2193965726b5f37afcdecc2e" UNIQUE ("protocolID"), CONSTRAINT "PK_3dac780820ff55792d8672d7015" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "protocols" ("id" SERIAL NOT NULL, "isAccreditation" boolean NOT NULL DEFAULT false, "creationDate" TIMESTAMP NOT NULL, "workDate" TIMESTAMP NOT NULL, "workObject" character varying NOT NULL, "copies" integer NOT NULL DEFAULT '1', "workSheetNum" integer, "isLssied" boolean NOT NULL DEFAULT false, "note" character varying, "reasonTypeID" integer, "workTypeID" integer, "protocolStatusID" integer, "customerID" integer, "staffID" integer, CONSTRAINT "PK_69900eec42c88582ac8affff3e1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "staff_groups" ("id" SERIAL NOT NULL, "staffGroup" character varying(50) NOT NULL, "canViewRecords" boolean NOT NULL, "canAddRecords" boolean NOT NULL, "canEditRecords" boolean NOT NULL, "canDeleteRecords" boolean NOT NULL, "canAccessFiles" boolean NOT NULL, "fullAccess" boolean NOT NULL, CONSTRAINT "UQ_a4ce7005279743f27731e7a41a6" UNIQUE ("staffGroup"), CONSTRAINT "PK_56653a5fa6c479171c4cdba7d49" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "protocol_files" ADD CONSTRAINT "FK_1f8e85327724d2ebf29f8627eb1" FOREIGN KEY ("protocolID") REFERENCES "protocols"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "issue_journal" ADD CONSTRAINT "FK_bb2193965726b5f37afcdecc2ec" FOREIGN KEY ("protocolID") REFERENCES "protocols"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "issue_journal" DROP CONSTRAINT "FK_bb2193965726b5f37afcdecc2ec"`);
        ...
        await queryRunner.query(`ALTER TABLE "protocol_files" DROP CONSTRAINT "FK_1f8e85327724d2ebf29f8627eb1"`);
